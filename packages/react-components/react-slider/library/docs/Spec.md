...
| `startThumb` | `div`   | Visual-only thumb for the lower value. Wraps the native input and mirrors focus via `:focus-within`.      |
| `endThumb`   | `div`   | Visual-only thumb for the upper value. Wraps the native input.                                            |
